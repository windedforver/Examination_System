...
public class CoreStart {
	...
	public static void main(String[] args) {
		...
		// 初始化Spring容器
		String[] configLocations = new String[] { "spring/applicationContext-shiro.xml","spring/applicationContext-trsaction.xml","spring/applicationContext-dao.xml", "spring/applicationContext-service.xml","spring/springmvc.xml","mybatis/mybatis.cfg.xml" };
